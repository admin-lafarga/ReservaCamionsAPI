...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('reservas', function (Blueprint $table) {
            $table->id('reserva_id');
            $table->unsignedBigInteger('tipo_camion_id')->nullable();
            $table->unsignedBigInteger('tipo_material1_id')->nullable();
            ...
            $table->string('pedido_LF')->nullable();
            $table->string('matricula_camion')->nullable();
            $table->dateTime('inicio1');
            $table->dateTime('fin1');
            $table->dateTime('inicio2')->nullable();
            $table->dateTime('fin2')->nullable();
            $table->boolean('es_aduana')->default(false)->nullable();
            $table->string('notas')->nullable();
            $table->string('tel1')->nullable();
            $table->integer('duracion1')->nullable();
